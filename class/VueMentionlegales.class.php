    ...
    public function __toString()
    {
        ...
        <div class="mentions-legales">
            ...
            <div class="section-mentions hebergeur">
                ...
                <p><strong>Activité principale (NAF/APE):</strong>Traitement de données, hébergement et activités connexes</p>
                <p><strong>Adresse :</strong>Chem. des Pardiaux, 63000 Clermont-Ferrand </p>
                <p><strong>Numéro de téléphone :</strong> 04 44 44 60 40</p>
                <p><strong>Lien hébergeur :</strong> <a href="https://81.194.40.26" target="_blank">https://www.o2switch.fr/</a>
                </p>
            </div>

            <div class="section-mentions propriete">
                <h2>Propriété intellectuelle</h2>
                <p>Les contenus présents sur ce site, notamment le jeu Motus Star Wars, sont la propriété de leur auteur, sauf
                    mention contraire.</p>
                <p>L'univers Star Wars est la propriété de Lucasfilm Ltd. et The Walt Disney Company. Ce site est un projet
                    académique sans but commercial.</p>
            ...
            <div class="section-mentions activite">
                <h2>Activité</h2>
                <p><strong>Activité :</strong> Jeu de type Motus sur le thème Star Wars avec dictionnaire personnalisé, système
                    de tentatives et indices.</p>
            ...
            <div class="section-mentions cookies">
                ...
                <p>Le site utilise uniquement des cookies de session techniques nécessaires au fonctionnement du jeu (sauvegarde
                    des tentatives, du mot secret, etc.).</p>
            ...
            <div class="section-mentions description">
                ...
                <p>Ce site est un jeu de type Motus (mot mystère) sur le thème de l'univers Star Wars. Il a pour vocation
                    académique dans le cadre d'un parcours universitaire en BUT MMI.</p>
